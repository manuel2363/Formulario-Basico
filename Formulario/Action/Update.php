...
{
	echo"<form name='form1' method='post' action='Action/Update_1.php'><fieldset>";
	...
	echo "</td></tr><tr><td><center>";
	echo "<label for='telf'>Telefono:</label>  <em>* </em><input type='tel' name='usrtel' value='".$telefono."'readonly></center></td><td>";
	echo "<label for='telnuevo'>Telefono:</label>  <em>* </em><input type='tel' placeholder='(xxxx) xxx-xxxx' name='usrtel'>";
	echo "</td></tr><tr><td><center>";
	echo "<label for='email'>E-mail:</label>  <em>* </em><input type='email' name='email' value='".$email."'readonly> </center></td><td>";
	echo "<label for='emailnuevo'>E-mail:</label>  <em>* </em><input type='email' name='emailnuevo' placeholder='email@servidor.com'>";
	echo "</td></tr><tr><td><center>";
	echo "<label for='web'>Web:</label>  <em>* </em><input type='url' name='homepage' value= '".$pagina."'readonly></center></td><td>";
	echo "<label for='Webnuevo'>Web:</label>  <em>* </em><input type='url' name='homepagenuevo'></fieldset>";
